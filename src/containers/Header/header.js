        ...
        return (
            <div className="navbar-box navbar-skin">
                <div className="navbar-menu">
                    <Link className={'navbar-item logo ' + (location && location.pathname !== '/apps'&&'active')} title="首页" to="/">宜</Link>
                ...
                <div className="navbar-expanded">
                    <div>
                        ...
                        <a className="navbar-item change-mode" href="javascript:;" onClick={this.handleChangeMode.bind(this)}>
                ...
                <div className="navbar-shrink">
                    ...
                    <a className="pull-right navbar-item change-mode" href="javascript:;" onClick={this.handleChangeMode.bind(this)}>
                        {(styleMode === 'day-mode')?<i className="fa fa-sun-o"></i>:<i className="fa fa-moon-o"></i>}
                    </a>
